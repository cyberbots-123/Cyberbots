  ...
  const html = `
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; border: 1px solid #e2e8f0; border-radius: 8px; overflow: hidden;">
      <div style="background: #0f172a; padding: 24px 28px;">
        <h2 style="color: white; margin: 0; font-size: 18px;">📬 New Enquiry — ${contact.referenceNumber}</h2>
      </div>
      <div style="padding: 24px 28px; background: #f8f9fc;">
        <table style="width: 100%; border-collapse: collapse; font-size: 14px;">
          <tr><td style="padding: 6px 0; color: #64748b; width: 140px;">Name</td>
              <td style="padding: 6px 0; font-weight: 600;">${contact.firstName} ${contact.lastName}</td></tr>
          <tr><td style="padding: 6px 0; color: #64748b;">Email</td>
              <td style="padding: 6px 0;"><a href="mailto:${contact.email}">${contact.email}</a></td></tr>
          <tr><td style="padding: 6px 0; color: #64748b;">Phone</td>
              <td style="padding: 6px 0;">+91 ${contact.phone}</td></tr>
          <tr><td style="padding: 6px 0; color: #64748b;">Organisation</td>
              <td style="padding: 6px 0;">${contact.organisation || "—"}</td></tr>
          <tr><td style="padding: 6px 0; color: #64748b;">Enquiry Type</td>
              <td style="padding: 6px 0;">${contact.enquiryType}</td></tr>
          <tr><td style="padding: 6px 0; color: #64748b;">Source</td>
              <td style="padding: 6px 0;">${contact.hearAboutUs || "—"}</td></tr>
          <tr><td style="padding: 6px 0; color: #64748b; vertical-align: top;">Message</td>
              <td style="padding: 6px 0; white-space: pre-line;">${contact.message}</td></tr>
  ...
  const html = `
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; border: 1px solid #e2e8f0; border-radius: 8px; overflow: hidden;">
      ...
      <div style="padding: 24px 28px;">
        <p style="color: #0f172a; font-size: 15px;">Hi <strong>${contact.firstName}</strong>,</p>
        <p style="color: #475569; font-size: 14px; line-height: 1.7;">
          Thank you for reaching out to <strong>Cyberbots</strong>. We've received your enquiry
          (<strong>${contact.enquiryType}</strong>) and will get back to you within one business day.
        </p>
        <div style="margin: 20px 0; padding: 14px 18px; background: #f8f9fc; border-radius: 8px; border: 1px solid #e2e8f0;">
          ...
          <p style="margin: 4px 0 0; font-size: 20px; font-weight: 700; font-family: monospace; color: #1a56db;">${contact.referenceNumber}</p>
        </div>
